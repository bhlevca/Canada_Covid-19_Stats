...
# April 2022
#
# Adapted from CanadaCovid19daily.py
...
import matplotlib
#matplotlib.rcParams['backend'] = 'GTK4Cairo'  
...
class CanadaCovid19(object):
    ...
    def updateCountry(self,
        ...
        HEADER: pruid	prname	prnameFR	date	update	numconf	numprob	numdeaths	numtotal	numtested	numtests	numrecover	percentrecover	ratetested	ratetests	numtoday	percentoday	ratetotal	ratedeaths	numdeathstoday	percentdeath	numtestedtoday	numteststoday	numrecoveredtoday	percentactive	numactive	rateactive	numtotal_last14	ratetotal_last14	numdeaths_last14	ratedeaths_last14	numtotal_last7	ratetotal_last7	numdeaths_last7	ratedeaths_last7	avgtotal_last7	avgincidence_last7	avgdeaths_last7	avgratedeaths_last7
         ...
         NEW HEADER: pruid	prname	prnameFR	date	reporting_week	reporting_year	update	numcases_total	numcases_weekly	ratecases_total	numdeaths_total	numdeaths_weekly	ratedeaths_total	ratecases_last7	ratedeaths_last7	numcases_last14	numdeaths_last14	ratecases_last14	ratedeaths_last14	avgcases_last7	avgincidence_last7	avgdeaths_last7	avgratedeaths_last7

        :param url:
        :return:
        """
        url = url
        #s = requests.get(url, verify=True).content
        s = requests.get(url).content
        self.countrydf = pd.read_csv(io.StringIO(s.decode('utf-8')))
        #BH self.countrydf['date'] = pd.to_datetime(self.countrydf['date'], format='%d-%m-%Y')
        self.countrydf['date'] = pd.to_datetime(self.countrydf['date'], format='%Y-%m-%d')
    ...
    def process(self, country):
        ...
        if self._updated:
            ...
            country_df['newcases'] = country_df['numcases_weekly'] #country_df['numtoday']
            country_df['totaldeaths'] = country_df['numdeaths_total'] #country_df['numdeaths']
            country_df['totalcases'] = country_df['numcases_total'] #country_df['numtotal']
            #country_df['prcnewcases'] = country_df['ratecases_total'] #country_df['percentoday']
            ...
            for c in self.provincelist:
                if c != country:
                    ...
                    province_df['newcases'] = province_df['numcases_weekly'] #country_df['numtoday']
                    province_df['totaldeaths'] = province_df['numdeaths_total'] #country_df['numdeaths']
                    province_df['totalcases'] = province_df['numcases_total'] #country_df['numtotal']
                    ...
                    #province_df['numteste] = province_df['numtested']
    ...
    def plotProvince(self,
        ...
        if 0:
            ...
            plt.bar(dates.values, numtests, color='orange', edgecolor='orange')
            plt.xticks(rotation=45, fontsize=14)
            plt.subplots_adjust(bottom=0.22)
            plt.grid()
            plt.show()
    ...
    def plotMultiProvince(self,
        ...
        def draw_tangent(x, y, a):
            ...
            small_t = np.arange(asec - 35 * oneday, asec + 35 * oneday, step = oneday)
            ...
            plt.plot(xts, fa, 'om', small_ts, tan, ':', linewidth=2.5)
            plt.text(small_ts[0],
        ...
        def plotCountry(dates, cases, title, last_30_days=False,
            ...
            plt.legend(legend, fontsize=12, loc='upper left')
            plt.grid()
    ...
    def rankProvince(self,
        ...
        def plotBar(pos, cases, dt, color, title):
            ...
            axs[pos].set_title("{} in the week of {}".format(title, str(dt)), fontsize=15)
